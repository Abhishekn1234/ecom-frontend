...
const DropDownMenu = () => {
  return (
    <div className="drop-down-menu">
        ...
        <div className="header">
          ...
          <div className="frame-div">
            ...
            <div className="view-all">
              ...
              <img
                className="right-arrow-svgrepo-com-6-icon1"
                alt=""
                src="/rightarrowsvgrepocom-1.svg"
              />
            </div>
            <div className="service-list">
              <div className="service-list-child" />
              <div className="floor-screed">Floor Screed</div>
              <a className="rush-coat">Rush Coat</a>
      ...
      <img
        className="windows-cursor-logo-png-transp-icon1"
        loading="lazy"
        alt=""
        src="/windowscursorlogopngtransparent-11@2x.png"
      />
      <FrameComponent1 />
    </div>
  );
