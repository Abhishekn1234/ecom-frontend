...
const FrameComponent4 = ({ className = "" }) => {
  return (
    <div className={`rectangle-parent99 ${className}`}>
      <div className="frame-child41" />
      <div className="phone-icon-parent">
        <div className="phone-icon">
          <img
            className="phone-svgrepo-com-1-icon1"
            loading="lazy"
            alt=""
      ...
      <div className="choose-location-group">
        ...
        <div className="vector-container">
          <img className="vector-icon11" alt="" src="/flags.svg" />
        </div>
      </div>
      <div className="english-group">
        <a className="english1">English</a>
        <div className="vector-frame">
          <img className="vector-icon12" alt="" src="/flags.svg" />
        </div>
      </div>
    </div>
  );
