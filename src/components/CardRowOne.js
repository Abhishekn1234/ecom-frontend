    ...
    <div className={`card-row-one ${className}`}>
      ...
      <div className="frame-parent21">
        <div className="iconlyboldchart-wrapper">
          <img className="iconlyboldchart" loading="lazy" alt="" src={iconlyBoldChart} />
        </div>
        <div className="card-one-description">
          ...
          <div className="lorem-ipsum-dolor6">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque dui mi, bibendum eu erat id, ultricies semper metus. Nunc</div>
        </div>
      </div>
      <div className="card-row-one-inner">
        <button className="rectangle-parent163">
