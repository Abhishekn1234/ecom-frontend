      ...
      <div className="services-content">
        <div className="services-header">
          <div className="services-title">
            ...
            <div className="card-one-icon">
              <img className="card-one-icon-child" alt="" src="/vector-5-1.svg" />
            </div>
          </div>
        </div>
        <div className="service-cards">
          <div className="card-row-one1">
            ...
            <img className="iconlyboldactivity" loading="lazy" alt="" src="/iconlyboldactivity.svg" />
            <div className="lorem-ipsum-dolor7">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque dui mi, bibendum eu erat id, ultricies semper metus. Nunc</div>
            <div className="card-three-content">
              <button className="rectangle-parent164">
                <div className="frame-child122" />
                <div className="learn-more2">Learn More</div>
              </button>
            </div>
          </div><CardRowOne iconlyBoldChart="/iconlyboldchart.svg" /><CardRowOne iconlyBoldChart="/dashboardsvgrepocom-1.svg" />
        </div>
      </div>
    </section>);
};
